...
import HeaderSyana from '@/components/headerSyana.vue'
import FooterSyana from '@/components/footerSyana.vue'
import RelatedSyana from '@/components/relatedSyana.vue'
